# -*- coding: utf-8 -*-
"""Univariate_storage_forecasting_with_Lag36.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1x53xVgfAd6fTbH1RRsIr2M9QO1ZmQbue
"""
...
dataset = read_csv('/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Final_Lag36_storage_Data.csv', header=0,index_col=0)
...
#    valResults   = DataFrame()
    for i in range(1):
        ...
        for j in range(30):
            ...
            pd.DataFrame(model.fit(train_X_reshaped, train_y, epochs=2000, batch_size=30, validation_data=(test_X_reshaped, test_y), verbose=1, shuffle=False).history).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/UVSTO_history"+str(j)+".csv")
            ...
            forecast32.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TrainsetCSVs/36Lags/trainsetcsv"+str(j)+".csv")
            ...
            forecast321.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TestsetCSVs/36Lags/testsetcsv"+str(j)+".csv")
            ...
            forecast322.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/ValsetCSVs/36Lags/valsetcsv"+str(j)+".csv")
            m =[]
            m1=[]
            m2=[]
            m3=[]
...
pd.DataFrame(trainstd_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/stdtrainset.csv")
pd.DataFrame(teststd_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/stdtestset.csv")
pd.DataFrame(valstd_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/stdvalset.csv")
pd.DataFrame(trainRMSE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsetrainset.csv")
pd.DataFrame(trainMAPE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapetrainset.csv")
pd.DataFrame(testRMSE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsetestset.csv")
pd.DataFrame(testMAPE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapetestset.csv")
pd.DataFrame(valRMSE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsevalset.csv")
pd.DataFrame(valMAPE_calc_list).to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapevalset.csv")

"""##SAVE RMSE AND MAPE IN CSV FILES"""

import pandas as pd
import numpy as np
df  = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsetrainset.csv",index_col=0,header = 0)
...
df1 = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapetrainset.csv",index_col=0,header = 0)
...
df2  = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsetestset.csv",index_col=0,header = 0)
...
df3  = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapetestset.csv",index_col=0,header = 0)
...
df4  = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/rmsevalset.csv",index_col=0,header = 0)
...
df5  = pd.read_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/mapevalset.csv",index_col=0,header = 0)
...
RFreport.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Performances/36Lags/Lag36_Sto_performancereport.csv")

"""##CONCATENATE THE 30 SIMULATED STORAGE IN ONE CSV AND COMPUTE AVERAGE PREDICTIONS"""
...
path = r'./gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TrainsetCSVs/36Lags' # use your path
...
frame.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TrainsetCSVs/36Lags/concat_predictions.csv")
frame1.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TrainsetCSVs/36Lags/mean_predictions.csv")

path = r'./gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TestsetCSVs/36Lags' # use your path
all_files = glob.glob(path + "/*.csv")
...
frame = pd.concat(li, axis=1, ignore_index=False)
frame1 = frame.mean(axis = 1) 
frame.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TestsetCSVs/36Lags/concat_predictions.csv")
frame1.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/TestsetCSVs/36Lags/mean_predictions.csv")

path = r'./gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/ValsetCSVs/36Lags' # use your path
all_files = glob.glob(path + "/*.csv")
...
frame.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/ValsetCSVs/36Lags/concat_predictions.csv")
frame1.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/ValsetCSVs/36Lags/mean_predictions.csv")

"""##CONCATENATE LOSS HISTORY IN ONE CSV AND COMPUTE AVERAGE"""

import pandas as pd
import glob
path = r'./content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags' # use your path
for j in range(30):
  all_files = glob.glob(path + "/UVSTO_history"+str(j)+".csv")
...
frame1.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/concat_loss_function.csv")
frame2.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/concat_val_loss_function.csv")
frame3.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/mean_loss_function.csv")
frame4.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/mean_val_loss_function.csv")
loss = pd.concat([frame3,frame4],axis = 1,ignore_index=False)
loss.to_csv("/content/gdrive/My Drive/PHD_THESIS/PAPER1/STORAGE_FORECAST/UVLSTM/Results/Loss_history/36Lags/mean_loss_val_loss_functions.csv")
